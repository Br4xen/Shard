...
namespace Shard
{
    class GameMissileCommand : Game, InputListener
    {
        ...
        {
            foreach (Background c in cities)
            {
        ...
        public override void initialize()
        {
            ...
            counter = 0;
            cities = new List<Background>();


            // Creates cities and places them correctly. 
            for (int i = 0; i < 6; i++)
            {
