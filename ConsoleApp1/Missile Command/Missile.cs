...
namespace MissileCommand
{
    class Missile : GameObject, CollisionHandler
    {
        ...
        private Random rand;
        private bool mirv;
        private List<Background> theTargets;
        ...
        internal List<Background> TheTargets { get => theTargets; set => theTargets = value; }
        ...
        {
            float xDist, yDist;
            List<Background> remainingCities;
            int numWarheads = 3;
            Vector2 v;
            ...
            if (mirv)
            {
                if (mirvCount > 10)
                {
                    ...
                    remainingCities = new List<Background>();
                    foreach (Background c in TheTargets)
                    {
